...
class HowDoesBygoWorkVC: UIViewController, UIScrollViewDelegate {
...
//            titleLabel0.frame.origin.x = 0 - scrollView.contentOffset.x/0.5
//            titleLabel1.frame.origin.x = view.bounds.width - (scrollView.contentOffset.x/0.5 - (view.bounds.width))
//            titleLabel2.frame.origin.x = (2.0*view.bounds.width) - (scrollView.contentOffset.x/0.5 - (2.0*view.bounds.width))
//            titleLabel3.frame.origin.x = (3.0*view.bounds.width) - (scrollView.contentOffset.x/0.5 - (3.0*view.bounds.width))
